...
public class UrlControllerIntegrationTest {
    ...
    class Redirect {
        ...
        @Test
        void shouldReturn403GoneWhenUrlExpired() throws Exception {
    ...
    private ResultActions stubUpdateById(Long id, UpdateUrlRequest request, UrlResponse response) throws Exception {
        when(urlService.updateById(anyLong(), any(UpdateUrlRequest.class))).thenReturn(response);
